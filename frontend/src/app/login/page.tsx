...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            {/* Background effects */}
            <div className="fixed inset-0 bg-hero-gradient opacity-5" />
            <div className="fixed inset-0 bg-gradient-to-t from-background via-transparent to-transparent" />
            ...
            <div className="relative w-full max-w-md space-y-8">
                ...
                <div className="text-center">
                    <Link href="/" className="inline-flex items-center gap-3 mb-8">
                        ...
                        <h1 className="text-3xl font-display font-bold text-gradient">TellSpike</h1>
                    </Link>
